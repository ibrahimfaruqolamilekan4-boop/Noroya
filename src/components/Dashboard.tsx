    ...
    <div className={cn(
      ...
      <aside className="hidden md:flex flex-col w-64 shrink-0 bg-white border-r border-slate-100 text-slate-900">
        ...
        <div className="p-4 border-t border-slate-100">
          <button 
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-rose-500 hover:bg-rose-50 hover:text-rose-600 transition-all text-sm font-extrabold"
          >
            <LogOut size={20} />
            Logout Account
          </button>
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 z-[60] md:hidden">
            ...
            <motion.aside
              ...
              className="absolute top-0 bottom-0 left-0 w-72 p-6 flex flex-col shadow-2xl bg-white text-slate-900"
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => setIsMobileMenuOpen(false)} className="p-1 px-1.5 bg-slate-50 rounded-lg text-slate-600">
                  <X size={18} />
                </button>
              </div>
              ...
              <div className="pt-4 border-t border-slate-100">
                <button 
                  onClick={handleLoggedOut}
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-rose-500 hover:bg-rose-50 font-bold transition-all text-sm"
                >
                  <LogOut size={20} />
                  Logout Account
                </button>
      ...
      <main className="flex-1 flex flex-col overflow-hidden font-sans">
        ...
        <div className={cn(
          ...
          isDarkMode ? "bg-slate-950 text-slate-100" : "bg-slate-50 text-[#1A1A1A]"
        )}>
