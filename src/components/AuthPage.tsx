        ...
        <div className="w-full max-w-md py-6">
          <div className="lg:hidden text-center mb-8">
            ...
            <div className="flex justify-center items-center gap-2 text-emerald-600">
              ...
              <p className="text-[10px] font-bold uppercase tracking-wider">Secure • Instant • Reliable</p>
            </div>
          </div>
          ...
          >
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="mb-6 p-4 bg-rose-50 border-2 border-rose-200 rounded-2xl flex gap-3 text-rose-800 text-sm font-bold items-start"
              >
            ...
            {mode === 'otp' ? (
              <div className="space-y-8">
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm text-slate-600 font-medium">We sent a 6-digit verification code.</p>
                </div>
                ...
                <div className="text-center text-xs font-medium text-slate-500">
                  Did not get it?{' '}
                  <button type="button" className="text-emerald-600 font-black hover:underline">
                    Resend code
                  </button>
                </div>
              </div>
            ...
            <form onSubmit={handleEmailAuth} className="space-y-5">
                ...
                <>
                  ...
                  <div className="space-y-2 bg-gradient-to-r from-emerald-50/50 to-cyan-50/50 border-2 border-emerald-200/30 rounded-2xl p-4">
                    <label className="text-[10px] uppercase font-black text-slate-600 ml-0 flex items-center justify-between">
                      <span className="flex items-center gap-1">
                        <TrendingUp size={12} /> Referral Code (Optional)
                      </span>
              ...
              <div className="relative py-5">
                ...
                <div className="relative flex justify-center text-[10px] uppercase font-black text-slate-400 tracking-tight">
